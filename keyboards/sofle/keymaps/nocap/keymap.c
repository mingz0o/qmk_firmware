...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_GAMING,     KC_MUTE,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Shift| Left | Down | Right|      |      |-------.    ,-------|      |      |  Ins | Home | PUp  |      |
 * |------+------+------+------+------+------|  play |    | mute  |------+------+------+------+------+------|
 * | LCTRL|      |      | copy | paste|      |-------|    |-------|      | Menu |  Del |  End | PDown|      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, KC_INS, KC_HOME, KC_PGUP, XXXXXXX,
  KC_LCTRL, XXXXXXX, XXXXXXX, KC_COPY, KC_PASTE, XXXXXXX, _______,       _______, XXXXXXX, KC_APP, KC_DEL, KC_END, KC_PGDN, XXXXXXX,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------|   left   | down | up | right|  nextword | Bspc  |
 * |------+------+------+------+------+------|  PLAY |    | mute     |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_LEFT,  KC_DOWN, KC_UP, KC_RIGHT,  KC_NXTWD, KC_BSPC,
